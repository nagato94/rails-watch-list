poster_url = [{title: "Wonder Woman 1984", overview: "Wonder Woman comes into conflict with the Soviet Union during the Cold War in the 1980s", poster_url: "https://image.tmdb.org/t/p/original/8UlWHLMpgZm9bx6QYh0NFoq67TZ.jpg", rating: 6.9},
...
poster_url.each do |poster|
  img = URI.open(poster[:poster_url])
  movie = Movie.new(title: poster[:title], overview: poster[:overview], rating: poster[:rating])
  movie.photo.attach(io: img, filename: movie.title, content_type: "image/jpg")
  movie.save
end
